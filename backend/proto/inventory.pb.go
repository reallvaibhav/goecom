...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\fListProducts\x12\x1e.inventory.ListProductsRequest\x1a\x1f.inventory.ListProductsResponse\x12H\n" +
	"\vAdjustStock\x12\x1d.inventory.AdjustStockRequest\x1a\x1a.inventory.ProductResponseB\tZ\a./protob\x06proto3"
...
var file_proto_inventory_proto_depIdxs = []int32{
	...
	5, // 6: inventory.InventoryService.AdjustStock:input_type -> inventory.AdjustStockRequest
	...
	6, // 12: inventory.InventoryService.AdjustStock:output_type -> inventory.ProductResponse
